...
class NewEventAppMain extends StatelessWidget {
  String text1;

  NewEventAppMain({this.text1});
...
class NewEventApp extends StatelessWidget {
  String text4;

  NewEventApp({this.text4});
