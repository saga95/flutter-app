...
class DetailAttending extends StatelessWidget {
  DetailAttending(
      {this.name,
        this.pic,
        this.description,
      ...
      children: <Widget>[
        new Expanded(
          child: new RaisedButton(
            ...
            onPressed: () => _deleteEventFromGoing(EventName, context),
          ),
        ),
      ],
    );
...
void _deleteEventFromGoing(String Eventname, BuildContext context) {

  Firestore.instance
      .document("Users/U001/AttendingEvents/$Eventname")
      .delete()
      .whenComplete(() {
