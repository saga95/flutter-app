...
class CategorySearchAppMain extends StatelessWidget {
  String text1;

  CategorySearchAppMain({this.text1});
      ...
      body: new Container(
        child: new Column(
          children: <Widget>[
            ...
            new Flexible(
              flex: 51,
              child: CategorySearchApp(text4: text3),
            ),
          ],
        ),
      ),
...
class CategorySearchApp extends StatelessWidget {
  String text4;

  CategorySearchApp({this.text4});
    ...
    return new Container(
      child: new StreamBuilder(
        stream: Firestore.instance
            .collection('Events')
            .where('Category', isEqualTo: '$text4')
            .snapshots(),
