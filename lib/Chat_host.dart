          ...
          actions: <Widget>[
            ...
            IconButton(
                ...
                onPressed: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => RemoveUserList()),
                  );
                }
            ),
...
class _AddState extends State<UserList>{
...
class RemoveUserList extends StatefulWidget{
  @override
  _RemoveState createState() => new _RemoveState();
// TODO: implement createState

}

class _RemoveState extends State<RemoveUserList>{

  List<bool> _removeData = new List<bool> ();

  @override
  void initState(){
    setState((){
      for(int i = 0; i<1000; i++){
        _removeData.add(false);
      }
    });
  }
              ...
              child: new Container(
                ...
                child: new Column(
                  children: <Widget>[
                    new Text("User 01"),
                    new CheckboxListTile(
                      value: _removeData[index],
                      controlAffinity: ListTileControlAffinity.leading,
                      title: new Text("Remove User"),
                      onChanged: (bool value){
                        _onChange(value, index);
                      },
                    )
