...
import 'package:gridview_test/EventDescPageFromNewEventApp.dart';
...
class NewEventAppMainFromMap extends StatelessWidget {
  String text1;

  NewEventAppMainFromMap({this.text1});
      ...
      body: new Container(
        child: new Column(
          children: <Widget>[
            ...
            new Flexible(
              flex: 51,
              child: NewEventAppFromMap(text4: text3),
            ),
            new Flexible(
              flex: 6,
...
class NewEventAppFromMap extends StatelessWidget {
  String text4;

  NewEventAppFromMap({this.text4});
                    ...
                    child: new Material(
                      child: InkWell(
                        onTap: () => Navigator
                          ...
                          builder: (BuildContext context) => new NewDetail(
